        ...
        >
          ...
          <div className="mx-2 grid grid-cols-3 gap-3 max-xl:grid-cols-2 max-lg:grid-cols-1">
            {Certifications_data.map((c) => (
              <div
                key={c.id}
                className={`${isDark ? "h-180 border border-solid border-white" : "h-200 shadow-[2px_2px_5px_#BABECC,-5px_-5px_10px_#ffffff73]"} flex flex-col justify-between overflow-hidden rounded-2xl *:capitalize`}
              >
                <img
                  loading="lazy"
                  decoding="async"
                ...
                />
                <div
                  className={`${isDark ? "h-60" : "h-80"} flex flex-col gap-6`}
                >
                  <div
                  ...
                  <p
                    className={`${isDark ? "text-(--text-primary)" : "mx-2 rounded-md text-(--text-dark) shadow-[2px_2px_5px_#BABECC,-5px_-5px_10px_#ffffff73]"} p-2 text-[12px] leading-relaxed font-bold`}
                  >
                    {c.content}
                  </p>
                </div>
                ...
                >
                  <button
                    className={`${isDark ? "bg-blue-600 text-white" : "text-black shadow-[2px_2px_5px_#BABECC,-5px_-5px_10px_#ffffff73] hover:shadow-[inset_2px_2px_5px_#BABECC,inset_-5px_-5px_10px_#ffffff73]"} w-[70%] cursor-pointer rounded-2xl p-2 hover:font-extrabold`}
                  >
                    view certificate
                  </button>
                </a>
